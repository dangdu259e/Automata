...
line    : assignment ';'		{;} // Không làm bất cứ điều gì khi nhận được dấu ;
		| exit_command ';'		{exit(EXIT_SUCCESS);} // Exit khỏi ctrình
		| print exp ';'			{printf("Printing %d\n", $2);} // in biểu thức
		| line assignment ';'	{;} // dòng
		| line print exp ';'	{printf("Printing %d\n", $3);} // in ra dòng biểu thức
		| line exit_command ';'	{exit(EXIT_SUCCESS);} // dòng kết thúc
        ;
